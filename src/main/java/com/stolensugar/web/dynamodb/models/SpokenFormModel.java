...
public class SpokenFormModel {
    @Getter(onMethod_={@DynamoDBHashKey}) @Setter @EqualsAndHashCode.Include private String fullName;
    @Getter(onMethod_={@DynamoDBAttribute}) @Setter private String command;
    @Getter(onMethod_={@DynamoDBAttribute}) @Setter private String fileName;
